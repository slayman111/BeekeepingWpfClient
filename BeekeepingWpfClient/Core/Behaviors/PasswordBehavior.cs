...
namespace BeekeepingWpfClient.Core.Behaviors;
...
public class PasswordBehavior : Behavior<PasswordBox>
{
    ...
    protected override void OnAttached() => AssociatedObject.PasswordChanged += PasswordBox_PasswordChanged;

    protected override void OnDetaching() => AssociatedObject.PasswordChanged -= PasswordBox_PasswordChanged;
